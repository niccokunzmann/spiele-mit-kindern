...
function readyAndToChangeTheDocument() {  
  ...
  if ((typeof Showdown === 'undefined') || (typeof Showdown.converter === 'undefined') || (!(window.$))) {
    window.setTimeout(readyAndToChangeTheDocument, 50);
  } else {
